...
class AppController extends Controller {
  protected $a_contain = array('Amendment', 'EthicalCommittee', 'InvestigatorContact', 'Pharmacist', 'Sponsor', 'SiteDetail'  => array('County'), 'Organization', 'Placebo',
                ...
                'AnnualApproval','AmendmentApproval' => array('Attachment'),'AmendmentApprovalSummary' => array('Attachment'),'AmendmentChecklist','AmendmentLetter', 'ParticipantFlow', 'Budget', 'Document', 'ActiveInspector',
