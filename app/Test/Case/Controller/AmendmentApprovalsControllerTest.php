<?php
App::uses('AmendmentApprovalsController', 'Controller');

/**
 * AmendmentApprovalsController Test Case
 *
 */
class AmendmentApprovalsControllerTest extends ControllerTestCase {
