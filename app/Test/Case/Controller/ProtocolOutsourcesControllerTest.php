<?php
App::uses('ProtocolOutsourcesController', 'Controller');

/**
 * ProtocolOutsourcesController Test Case
 *
 */
class ProtocolOutsourcesControllerTest extends ControllerTestCase {
