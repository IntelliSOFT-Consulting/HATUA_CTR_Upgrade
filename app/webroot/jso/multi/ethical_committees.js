$(function() {
	...
	function addEthicalCommittee() {
        ...
        <div class="control-group"><label class="control-label required">Name of Ethics Review Committee (ERC)  <span class="sterix">*</span></label><div class="controls">\
				...
				<div class="control-group"><label class="control-label required">Date of initial complete submission to ERC  <span class="sterix">*</span></label>\
				...
				<div class="control-group"><label class="control-label required">ERC Number  <span class="sterix">*</span></label><div class="controls"><input name="data[EthicalCommittee]['+ intId +'][erc_number]" \
