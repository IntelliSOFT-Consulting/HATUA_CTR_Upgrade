$(function() {
	...
	function addEthicalCommittee() {
        ...
        <div class="control-group"><label class="control-label required">Ethics Review Committee (ERC)</label><div class="controls">\
				...
				<div class="control-group" id="EthicalCommittee'+ intId +']"><label class="control-label">Approval date</label><div class="controls"><input name="data[EthicalCommittee]['+ intId +'][initial_approval]"\
