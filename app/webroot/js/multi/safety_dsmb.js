$(function() {
    ...
    if ($("#builddsmbform tr").length == 1 ) { $("#attachmentsTableHeader").hide(); }
    
    // incremental development
    $("#addDsbm").click(function() {
        $("#attachmentsTableHeader").show();
        var intId = $("#builddsmbform tr").length - 1;
        if ($('#builddsmbform :input[type="file"]').length < 4) {
            $("#builddsmbform").append(constructATr(intId));
            setAttachmentUpload();
        } else {
