$(function() {
    ...
    var trWrapper = '\
          <div class="row-fluid attacho">\
            <div class="span10"><input name="data[Attachment][{i}][id]" id="attachments-{i}-id" type="hidden"> \
                ...
                <input type="hidden" id="attachments-{i}-model" value="AmendmentApproval" name="data[Attachment][{i}][model]" style="display: inline;">\
    ...
    $(".addUploadAmendmentApproval").click(function() {
      intId = intId + 1; 
