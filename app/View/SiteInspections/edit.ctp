...
<?php echo $this->Form->create('SiteInspection'); ?>
	<fieldset>
		<legend><?php echo __('Edit Site Inspection'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SiteInspection.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SiteInspection.id'))); ?></li>
