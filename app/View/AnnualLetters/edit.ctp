...
<?php echo $this->Form->create('AnnualLetter'); ?>
	<fieldset>
		<legend><?php echo __('Edit Approval Letter'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AnnualLetter.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AnnualLetter.id'))); ?></li>
