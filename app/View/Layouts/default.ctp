              ...
              <ul class="nav topnav">
                ...
                <li class="dropdown <?php echo $this->fetch('Applications') ?>">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <?php echo $this->Html->link('<i class="icon-thumbs-up"></i> Approved', ['controller' => 'applications', 'action' => 'index','approved' => '2','admin' => false],array('escape'=>false)); ?>
                    </li>
                    <li>
                      <?php echo $this->Html->link('<i class="icon-trash"></i>Rejected', ['controller' => 'applications', 'action' => 'index','approved' => '1', 'admin' => false],array('escape'=>false)); ?>
                    </li>
                  </ul>
                  <!-- <?php echo $this->Html->link('<i class="icon-thumbs-up"></i> Clinical Trials', array('controller' => 'applications', 'action' => 'index', 'admin' => false,), array('escape' => false)); ?> -->
                </li>
