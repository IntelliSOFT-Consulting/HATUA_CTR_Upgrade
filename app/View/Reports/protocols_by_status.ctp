...
echo $this->Form->create('Application', array(
    'url' => array_merge(array('controller'=>'reports','action' => 'protocols_by_status')),
...
<div id="protocols-by-status"></div>
    ...
    <tbody>
      <?php
          foreach ($data as $key => $value) {
              echo "<tr>";
                echo "<th>".$value['TrialStatus']['name']."</th>";
...
Highcharts.chart('protocols-by-status', {
    data: {
        table: 'datatable8'
    },
    chart: {
