<div class="concomittantDrugs index">
	...
	<?php
	foreach ($concomittantDrugs as $concomittantDrug): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $concomittantDrug['ConcomittantDrug']['id']), null, __('Are you sure you want to delete # %s?', $concomittantDrug['ConcomittantDrug']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
