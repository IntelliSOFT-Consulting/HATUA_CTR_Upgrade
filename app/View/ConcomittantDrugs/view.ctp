...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Concomittant Drug'), array('action' => 'delete', $concomittantDrug['ConcomittantDrug']['id']), null, __('Are you sure you want to delete # %s?', $concomittantDrug['ConcomittantDrug']['id'])); ?> </li>
