...
<?php echo $this->Form->create('ConcomittantDrug'); ?>
	<fieldset>
		<legend><?php echo __('Edit Concomittant Drug'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ConcomittantDrug.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ConcomittantDrug.id'))); ?></li>
