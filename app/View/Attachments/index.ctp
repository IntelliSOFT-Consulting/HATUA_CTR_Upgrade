<div class="attachments index">
	...
	<tr>
		...
		<td><?php echo h($attachment['Attachment']['dirname']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['basename']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['checksum']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'index', $attachment['Attachment']['id']), null, __('Are you sure you want to delete # %s?', $attachment['Attachment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
