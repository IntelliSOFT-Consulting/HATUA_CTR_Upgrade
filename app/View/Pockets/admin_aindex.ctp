...
<div class="row-index">
    ...
    <tr>
        ...
        <td class="actions">
            <?php echo $this->Html->link(__('Edit'), array('controller' => 'pockets', 'action' => 'aedit', $pocket['Pocket']['id'], 'admin' => true), array('class' => 'btn btn-success')); ?>
        </td>
    </tr>
<?php endforeach; ?>
    </table>
    ...
    <div class="form-actions">
      <?php echo $this->Html->link(__('New Pocket'), array('controller' => 'pockets', 'action' => 'aadd', 'admin' => true), array('class' => 'btn btn-primary')); ?>
    </div>
</div>
