...
<ul id="mds_tab" class="nav nav-tabs">
  <li class="active"><a href="#meetingDate_form">SAE/SUSAR</a></li> 
  <li><a href="#external_md_comments">Feedback (<?php echo count($meetingDate['Comment']); ?>)</a></li>
</ul>
      ...
      <div class="span12">
        <br>
          <div class="amend-form">
            ...
            <div class="row-fluid">
              <div class="span8">    
                <?php echo $this->element('comments/list', ['comments' => $meetingDate['Comment']]) ?> 
              </div>
...
$(function() {
    ...
    if (ciomsTab != null) {
        $('#mds_tab a[href="' + ciomsTab + '"]').tab('show');
    }
