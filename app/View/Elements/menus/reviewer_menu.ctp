<div class="navbar navbar-inverse">
  ...
  <div class="container">
    ...
    <a href="#" class="brand">Reviewer Menu ::</a>
      <?php
    ...
    <ul class="nav">
      <li class="<?php echo $this->fetch('Dashboard') ?>">
        <?php
          ...
          array('controller' => 'users', 'action'=>'dashboard', 'reviewer' => true ), array('escape' => false ));
            ?>
       </li>
       <li class="<?php echo $this->fetch('Applications') ?>">
        <?php
          echo $this->Html->link('<i class="icon-file"></i> My Applications',
            array('controller' => 'applications', 'action'=>'index', 'reviewer' => true ), array('escape' => false ));
            ?>
       </li>
       <li class="<?php echo $this->fetch('ContactUs') ?>">
        <?php
          echo $this->Html->link('<i class="icon-comment-alt"></i> My Messages',
            array('controller' => 'feedbacks', 'action'=>'add', 'reviewer' => false ), array('escape' => false ));
            ?>
       </li>
