<?php
	$this->Html->script('multi/attachments_manager_comments', array('inline' => false));
?>
<div class="row-fluid">
	<div class="span12">
	 <hr>

		<h5><i class="icon-file"></i> Do you have files that you would like to send? click on the button to add them:
			<button type="button" class="btn-mini" id="addCommentAt">&nbsp;<i class="icon-plus"></i>&nbsp;</button>
		</h5>
	    	<table id="managercommentform"  class="table table-bordered  table-condensed table-striped">
			<thead>
			  <tr id="managerTableHeader">
				<th>#</th>
				<th width="45%">File</th>
