<?php
$this->Html->script('multi/safety_dsur', array('inline' => false));
?>
<div class="row-fluid">
    <div class="span12">
        ...
        <h5><i class="icon-file"></i> Click on the button to add the files:
            <button type="button" class="btn-mini" id="addDsur">&nbsp;<i class="icon-plus"></i>&nbsp;</button>
        </h5>
        <table id="dsursform" class="table table-bordered  table-condensed table-striped">
            <thead>
