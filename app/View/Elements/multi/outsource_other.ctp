<?php
$this->Html->script('multi/outsource_other', array('inline' => false));
?>
<div class="row-fluid">
    <div class="span12">
        <h4>Supporting Documents-
            <small class="muted">(Share supporting documents for the outsourced user)</small>
        </h4>
        <hr>

        <h5><i class="icon-file"></i> Click on the button to add the files:
            <button type="button" class="btn-mini" id="addSupportingOther">&nbsp;<i class="icon-plus"></i>&nbsp;</button>
        </h5>
        <table id="buildoutsourceformother" class="table table-bordered  table-condensed table-striped">
            <thead>
