<?php
	$this->Html->script('multi/declaration', array('inline' => false));
...
<div class="row-fluid">
	<div class="span12">
		...
		<h5><i class="icon-file"></i> Click on the button to add them:
			  ...
			  <tr>
				...
				<td>
					<div class="control-group"><?php
						...
						echo $this->Form->input('Attachment.'.$i.'.model', array('type'=>'hidden', 'value'=>'Declaration'));
