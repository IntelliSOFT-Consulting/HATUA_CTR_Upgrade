<?php
$this->Html->script('multi/amendsalt', array('inline' => false));
?>
<div class="row-fluid">
    <div class="span12">
        <hr>

        <h5><i class="icon-file"></i> Click to add a cover letter
            <button type="button" class="btn-mini" id="addAmend">&nbsp;<i class="icon-plus"></i>&nbsp;</button>
        </h5>
        <p id="foreignKey" data-value="<?= h($current) ?>"></p>

        <table id="amendsform" class="table table-bordered  table-condensed table-striped">
            <thead>
                <tr id="amendHeader">
                    <th>#</th>
                    <th width="45%">File</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="control-group"><?php
                                                            ...
                                                            echo $this->Form->input('Attachment.' . $i . '.model', array('type' => 'hidden', 'value' => 'Amend'));
                                                            echo $this->Form->input('Attachment.' . $i . '.year', array('type' => 'hidden', 'value' => $counter));
                                                            ...
                                                            if (
                                                                ...
                                                                echo $this->Html->link(
                                                                    ...
                                                                    array(
                                                                        ...
                                                                        'action' => 'download',
                                                                        $this->request->data['Attachment'][$i]['id'],
                                                                        'full_base' => true
                                                                    ),
