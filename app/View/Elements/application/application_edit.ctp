      ...
      <div id="tabs">
        ...
        <div id="tabs-4">
          ...
          <?php
            ...
            echo $this->Form->error('Application.age_span', 'You have to select yes for either less than 18 years or greater than 18 years'
                        ,array('wrap' => 'span', 'class' => 'controls required error', 'escape'=> false));
          ?>
          <hr>
          <?php
          ...
          <?php
            ...
            echo $this->Form->error('Application.gender', 'Please select at least one gender below'
                        ,array('wrap' => 'span', 'class' => 'controls required error', 'escape'=> false));
            $genderError = '';
        ...
        <div id="tabs-5">
          ...
          <?php
            ...
            echo $this->Form->error('Application.site_exists', 'You have to select yes for either single site, muliple sites or multiple countries'
                        ,array('wrap' => 'span', 'class' => 'controls required error', 'escape'=> false));
          ?>
        ...
        <div id="tabs-8">
          ...
          <?php
            ...
            echo $this->Form->error('Application.scope', 'Please select at least one option for scope of the trial'
                        ,array('wrap' => 'span', 'class' => 'controls required error', 'escape'=> false));
            $scopeError = '';
          ...
          <?php
            ...
            echo $this->Form->error('Application.phase', 'Please select at least one option for trial type and phase'
                        ,array('wrap' => 'span', 'class' => 'controls required error', 'escape'=> false));
            $phaseError = '';
        ...
        <div id="tabs-9">
          ...
          <?php
            ...
            echo $this->Form->error('Application.design_options', 'Please select yes because some the the options for design controlled
