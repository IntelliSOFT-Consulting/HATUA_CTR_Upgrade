          ...
          <span>
            ...
            if (!empty($application['Application']['trial_status_id'])) {
             if ($application["Application"]["admin_stopped"] == 1){?>
              <p> <?php echo $trial_statuses[$application['Application']['trial_status_id']]; ?></p>
              <p> <?php echo $application['Application']['admin_stopped_reason']; ?></p>
              <?php }else{?>

              <p class="<?php if ($application["Application"]["submitted"] == 1) echo "xeditable tiptip"; ?> " data-type="select" data-name="data[Application][trial_status_id]" data-url="/applicant/applications/view/<?php echo $application["Application"]["id"]; ?>" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update trial status">
