...
<?php echo $this->Form->create('SiteDetail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Site Detail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SiteDetail.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SiteDetail.id'))); ?></li>
