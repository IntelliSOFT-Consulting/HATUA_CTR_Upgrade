...
<?php echo $this->Form->create('ReviewAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Review Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ReviewAnswer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ReviewAnswer.id'))); ?></li>
