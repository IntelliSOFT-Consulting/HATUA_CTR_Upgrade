...
<?php echo $this->Form->create('InvestigatorContact'); ?>
	<fieldset>
		<legend><?php echo __('Edit Investigator Contact'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InvestigatorContact.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('InvestigatorContact.id'))); ?></li>
