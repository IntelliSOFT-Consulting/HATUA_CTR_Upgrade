<div class="suspectedDrugs index">
	...
	<?php
	foreach ($suspectedDrugs as $suspectedDrug): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $suspectedDrug['SuspectedDrug']['id']), null, __('Are you sure you want to delete # %s?', $suspectedDrug['SuspectedDrug']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
