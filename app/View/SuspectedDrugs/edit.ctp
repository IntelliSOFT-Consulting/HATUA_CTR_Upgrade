...
<?php echo $this->Form->create('SuspectedDrug'); ?>
	<fieldset>
		<legend><?php echo __('Edit Suspected Drug'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SuspectedDrug.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SuspectedDrug.id'))); ?></li>
