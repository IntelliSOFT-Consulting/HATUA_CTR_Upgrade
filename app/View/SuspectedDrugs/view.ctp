...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Suspected Drug'), array('action' => 'delete', $suspectedDrug['SuspectedDrug']['id']), null, __('Are you sure you want to delete # %s?', $suspectedDrug['SuspectedDrug']['id'])); ?> </li>
