<?php
  $this->Html->script('conflict_inspector', array('inline' => false));
...
<?php $this->start('form-actions'); ?>
  <div class="form-actions">
    <div class="row-fluid">
      <div class="span4">
      <?php
        // echo $this->Html->link('Download PDF', array('action'=>'view', 'ext'=> 'pdf',                            $application['Application']['id'], 'reviewer' => true),
        // array('class' => 'btn btn-primary mapop', 'title'=>'Download PDF',                      'data-content' => 'Download the pdf version of the report',));
      ?>
      </div>
      <div class="span4">
        <?php
...
<section>
  ...
  <div class="span12">
    ...
    <div class="row-fluid">
	<?php
		echo $this->element('application/inspector_minimal_view');
	?>

    <div class="span4">
      <?php if(!$application['Application']['deactivated']) { ?>
      <h4 class="text-success">Application Site Inspection</h4>
      <hr>
      <?php
            echo $this->Form->create('ActiveInspector',
                      array('url' => array('controller' => 'active_inspectors', 'action' => 'respond')));
            $acceptedError = '';
            ...
            echo $this->Form->input('conflict', array(
              ...
              Do you have any conflict? <span class="sterix">*</span></label>  <div class="controls">
                <input type="hidden" value="" id="ActiveInspectorApproved_" name="data[ActiveInspector][conflict]"> <label class="radio inline">',
              'after' => '</label>',
            ...
            echo $this->Form->input('accepted', array(
              ...
              'before' => '<div class="control-group '.$acceptedError.'">
                      ...
                      <input type="hidden" value="" id="ActiveInspectorAccepted_" name="data[ActiveInspector][accepted]"> <label class="radio inline">',
              'after' => '</label>',
