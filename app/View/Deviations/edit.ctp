...
<?php echo $this->Form->create('Deviation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Deviation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Deviation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Deviation.id'))); ?></li>
